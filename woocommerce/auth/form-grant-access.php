...
<p class="wc-auth-actions">
	<a href="<?php echo esc_url( $granted_url ); ?>" class="btn-small button button-primary wc-auth-approve"><?php esc_html_e( 'Approve', 'woocommerce' ); ?></a>
	<a href="<?php echo esc_url( $return_url ); ?>" class="btn-small button wc-auth-deny"><?php esc_html_e( 'Deny', 'woocommerce' ); ?></a>
</p>
