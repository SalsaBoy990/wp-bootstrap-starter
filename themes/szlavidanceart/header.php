...
<body <?php body_class(); ?>>
	...
	<header id="masthead">
		<div class="bg-pink-contact container-max-width">
				...
				<div class="row mx-responsive m0 p0">
					<div class="col-12 p0 clearfix">
						<div class="navbar-nav d-block d-sm-block d-md-none float-left mr0 mtquarter mbquarter">
							<a class="min-size no-underline mr1" href="tel:+36302606411" rel="noreferrer noopener" target="_blank" title="Hívj fel minket!">06 (30) 260 64 11</a>
							<a class="min-size no-underline" href="mailto:szlavati.andrea.lyo@gmail.com" title="Üzenj nekünk!">szlavati.andrea.lyo@gmail.com</a>
						</div>
					</div>
				</div>
			</div>
